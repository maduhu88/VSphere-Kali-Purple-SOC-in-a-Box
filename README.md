...
# 2 - [Key Differences between Offensive Security's (Proxmox) and my (vSphere) SOC deployments](https://gitlab.com/phybroptyx/vsphere-kali-purple-soc-in-a-box/-/blob/edit_1/_documentation/2%20-%20Differences.md)
