...
**To build the virtual machine for the DETECT node, use the steps in Section 6.1 to create a new VM in vSphere, coupled with the data from [Table 2](https://gitlab.com/phybroptyx/vsphere-kali-purple-soc-in-a-box/-/blob/edit_1/_documentation/4%20-%20vSphere%20Configuration.md#442-detect-node-hardware) (Section 4.4.2). We will be using the Kali Purple 2023.3 ISO for the operating system in this section (Figure 9). Your resulting VM should appear as in Figure 10.**
