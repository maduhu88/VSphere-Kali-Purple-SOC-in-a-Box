...
1. In the vSphere web interface, click "Create/Register VM…" ![](https://gitlab.com/phybroptyx/vsphere-kali-purple-soc-in-a-box/-/blob/edit_1/_images/1._vSphere_-_New_VM.png)
