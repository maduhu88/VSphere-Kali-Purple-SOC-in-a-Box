...
**NOTE** : Set your own values for OPENCTI_ADMIN_EMAIL, OPENCTI_ADMIN_PASSWORD, and insert your IDENTIFY nodes FQDN into the OPENCTI\_BASE\_URL variable value.
